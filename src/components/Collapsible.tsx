...
>(({ title, titleId, actions, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'group/collapsible-header flex h-9 cursor-pointer items-center justify-between gap-1 px-1 text-sm font-bold hover:bg-muted data-panel-open:bg-secondary data-panel-open:hover:bg-secondary/60',
        className,
      )}
      {...props}
    >
      <div className="flex min-w-0 items-center gap-1">
        ...
        >
          <ChevronRightIcon className="transition-transform group-data-panel-open/collapsible-header:rotate-90" />
        </Button>
